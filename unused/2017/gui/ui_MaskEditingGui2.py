...
class Ui_MaskEditingGui2(object):
    def setupUi(self, MaskEditingGui2):
        ...
        self.gview_finalMask = QtGui.QGraphicsView(MaskEditingGui2)
        self.gview_finalMask.setObjectName(_fromUtf8("gview_finalMask"))
        self.gridLayout_2.addWidget(self.gview_finalMask, 0, 0, 1, 1)
        self.splitter = QtGui.QSplitter(MaskEditingGui2)
        self.splitter.setOrientation(QtCore.Qt.Vertical)
        self.splitter.setObjectName(_fromUtf8("splitter"))
        self.listview_maskModified = QtGui.QListView(self.splitter)
        self.listview_maskModified.setObjectName(_fromUtf8("listview_maskModified"))
