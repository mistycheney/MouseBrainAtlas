...
# class BrainLabelingGUI(QMainWindow, Ui_RectificationGUI):
    ...
    def save(self):
        ...
        df = DataFrame(dict(contour_entries_all)).T
        df.to_hdf(fn, 'contours')
    ...
    def load(self):
        ...
        contour_df, structure_df = DataManager.load_annotation_v3(stack=self.stack, annotation_rootdir=annotation_midbrainIncluded_v2_rootdir)
