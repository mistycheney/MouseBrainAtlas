...
####################################################################
# This uses only three process at compute_texton()
# 
# note: using http://stackoverflow.com/a/7489951 gives the same result
####################################################################
...
class FeatureExtractor(object):
    ...
    def compute_features(self):
        ...
        filtered = Pool().map(self.convolve_per_proc, range(self.n_kernel))
    ...
    def compute_texton(self):
        ...
        for iteration in range(n_iter):
            ...
            r = Pool().map(self.compute_dist_per_proc, zip(np.array_split(data, n_splits, axis=0), 
