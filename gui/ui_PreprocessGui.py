...
class Ui_PreprocessGui(object):
    def setupUi(self, PreprocessGui):
        ...
        self.gridLayout_2.addWidget(self.button_save_crop, 2, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.button_confirm_alignment, 0, 3, 1, 1)
