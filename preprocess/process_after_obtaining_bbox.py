...
x0, y0, w0, h0 = brainstem_bbox_lookup_midbrain[stack]
...
<<<<<<< HEAD:preprocess/process_after_obtaining_bbox.py
...
>>>>>>> 59024b314c48531109a5e8c376087309f95cc963:elastix/process_after_obtaining_bbox.py
    'x1': x,
    'y1': y,
    'x2': x+w-1,
    'y2': y+h-1})
