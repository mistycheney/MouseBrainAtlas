...
class Ui_AlignmentGui(object):
    def setupUi(self, AlignmentGui):
        ...
        self.label_previous_index = QtGui.QLabel(self.widget)
        ...
        self.label_current_index = QtGui.QLabel(self.widget1)
        ...
        self.comboBox_parameters = QtGui.QComboBox(self.widget1)
        ...
        self.button_align = QtGui.QPushButton(self.widget1)
