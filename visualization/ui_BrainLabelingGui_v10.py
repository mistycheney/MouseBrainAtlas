...
#
# Created: Wed Nov 11 13:45:46 2015
...
class Ui_BrainLabelingGui(object):
    def setupUi(self, BrainLabelingGui):
        ...
        BrainLabelingGui.resize(1787, 1448)
        ...
        self.spinBox_section = QtGui.QSpinBox(self.centralwidget)
        ...
        self.buttonsLayout.addWidget(self.spinBox_section)
        ...
        self.buttonsLayout.addWidget(self.button_updateDB)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1787, 25))
