...
init_cnts_allSecs = load_initial_contours(initCnts_dir=volume_dir,
                                          stack=stack,
                                          test_volume_atlas_projected=test_volume_atlas_projected,
...
for sec in range(first_sec, last_sec+1):
    ...
    create_if_not_exists(autoAnnotations_dir)
    ...
    valid_labels = set(labels) &  set(init_cnts.keys())
    print valid_labels
    ...
    for l in valid_labels:
        ...
        dense_scoremap_lossless = pad_scoremap(stack, sec, l, 
                                              scoremaps_rootdir=scoremaps_rootdir, 
