...
class Ui_BrainLabelingGui(object):
    def setupUi(self, BrainLabelingGui):
        ...
        BrainLabelingGui.resize(2080, 1113)
        ...
        self.button_saveProbStructures = QtGui.QPushButton(self.centralwidget)
        self.button_saveProbStructures.setObjectName(_fromUtf8("button_saveProbStructures"))
        self.horizontalLayout.addWidget(self.button_saveProbStructures)
        ...
        self.button_loadProbStructures = QtGui.QPushButton(self.centralwidget)
        self.button_loadProbStructures.setObjectName(_fromUtf8("button_loadProbStructures"))
        self.horizontalLayout.addWidget(self.button_loadProbStructures)
        ...
        self.button_loadUnwarpedStructure = QtGui.QPushButton(self.centralwidget)
        self.button_loadUnwarpedStructure.setObjectName(_fromUtf8("button_loadUnwarpedStructure"))
        self.horizontalLayout.addWidget(self.button_loadUnwarpedStructure)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 2080, 25))
    ...
    def retranslateUi(self, BrainLabelingGui):
        ...
        self.button_saveProbStructures.setText(_translate("BrainLabelingGui", "Save Prob Structures", None))
        ...
        self.button_loadUnwarpedStructure.setText(_translate("BrainLabelingGui", "Load Unwarped Structure", None))
