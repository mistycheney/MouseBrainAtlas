...
# Form implementation generated from reading ui file 'BrainLabelingGui_v14.ui'
#
...
class Ui_BrainLabelingGui(object):
    def setupUi(self, BrainLabelingGui):
        ...
        self.button_3view = QtGui.QPushButton(self.centralwidget)
        self.button_3view.setObjectName(_fromUtf8("button_3view"))
        self.horizontalLayout_2.addWidget(self.button_3view)
        ...
        self.section3_gview = QtGui.QGraphicsView(self.layoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.button_loadLabelingSec1 = QtGui.QPushButton(self.layoutWidget)
        ...
        self.section1_gview = QtGui.QGraphicsView(self.layoutWidget1)
        ...
        self.button_loadLabelingSec2 = QtGui.QPushButton(self.layoutWidget1)
        ...
        self.section2_gview = QtGui.QGraphicsView(self.layoutWidget2)
        ...
        self.button_loadLabelingSec3 = QtGui.QPushButton(self.layoutWidget2)
    ...
    def retranslateUi(self, BrainLabelingGui):
        ...
        self.button_3view.setText(_translate("BrainLabelingGui", "3-view", None))
