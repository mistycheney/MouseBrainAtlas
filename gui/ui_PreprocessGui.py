...
#
# Created: Sun Sep  4 13:15:08 2016
...
class Ui_PreprocessGui(object):
    def setupUi(self, PreprocessGui):
        ...
        PreprocessGui.resize(1248, 1081)
        ...
        self.gridLayout_2.addWidget(self.button_sort, 2, 0, 1, 1)
        ...
        self.horizontalLayout_7.addWidget(self.slide_gview)
        ...
        self.label_section2_seq = QtGui.QLabel(self.centralwidget)
        self.label_section2_seq.setObjectName(_fromUtf8("label_section2_seq"))
        self.horizontalLayout_3.addWidget(self.label_section2_seq)
        ...
        self.label_section3_seq = QtGui.QLabel(self.centralwidget)
        self.label_section3_seq.setObjectName(_fromUtf8("label_section3_seq"))
        self.horizontalLayout.addWidget(self.label_section3_seq)
        ...
        self.label_section1_seq = QtGui.QLabel(self.centralwidget)
        self.label_section1_seq.setObjectName(_fromUtf8("label_section1_seq"))
        self.horizontalLayout_4.addWidget(self.label_section1_seq)
    ...
    def retranslateUi(self, PreprocessGui):
        ...
        self.label_section2_seq.setText(_translate("PreprocessGui", "TextLabel", None))
        self.label_section3_filename.setText(_translate("PreprocessGui", "File", None))
        self.label_section3_seq.setText(_translate("PreprocessGui", "TextLabel", None))
        self.label_section1_filename.setText(_translate("PreprocessGui", "File", None))
        self.label_section1_seq.setText(_translate("PreprocessGui", "TextLabel", None))
