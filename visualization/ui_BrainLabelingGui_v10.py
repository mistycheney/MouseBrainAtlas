...
class Ui_BrainLabelingGui(object):
    def setupUi(self, BrainLabelingGui):
        ...
        self.canvaswidget = MplWidget(self.layoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.graphicsView_navMap = QtGui.QGraphicsView(self.layoutWidget)
        ...
        self.proposalSource_panel = QtGui.QGroupBox(self.layoutWidget)
        ...
        self.displayOption_panel = QtGui.QGroupBox(self.layoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.button_saveLabeling = QtGui.QPushButton(self.layoutWidget)
