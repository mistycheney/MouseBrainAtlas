...
class Ui_MaskEditingGui(object):
    def setupUi(self, MaskEditingGui):
        ...
        self.button_saveCurrFinalMasks.setObjectName(_fromUtf8("button_saveCurrFinalMasks"))
        ...
        self.button_saveAllFinalMasks.setObjectName(_fromUtf8("button_saveAllFinalMasks"))
        self.horizontalLayout.addWidget(self.button_saveAllFinalMasks)
        self.button_exportAllMasks = QtGui.QPushButton(MaskEditingGui)
        self.button_exportAllMasks.setObjectName(_fromUtf8("button_exportAllMasks"))
