...
class Ui_MaskEditingGui(object):
    def setupUi(self, MaskEditingGui):
        ...
        self.gview_2 = QtGui.QGraphicsView(self.layoutWidget)
        self.gview_2.setObjectName(_fromUtf8("gview_2"))
        self.verticalLayout.addWidget(self.gview_2)
        self.button_good_2 = QtGui.QPushButton(self.layoutWidget)
        ...
        self.gview_3 = QtGui.QGraphicsView(self.layoutWidget)
        self.gview_3.setObjectName(_fromUtf8("gview_3"))
        self.verticalLayout_4.addWidget(self.gview_3)
        self.button_good_3 = QtGui.QPushButton(self.layoutWidget)
        ...
        self.gview_4 = QtGui.QGraphicsView(self.layoutWidget)
        self.gview_4.setObjectName(_fromUtf8("gview_4"))
        self.verticalLayout_5.addWidget(self.gview_4)
        self.button_good_4 = QtGui.QPushButton(self.layoutWidget)
        ...
        self.listview_bad = QtGui.QListView(self.layoutWidget1)
        ...
        self.button_addToList = QtGui.QPushButton(self.layoutWidget1)
        self.button_addToList.setObjectName(_fromUtf8("button_addToList"))
        self.horizontalLayout.addWidget(self.button_addToList)
        self.button_removeFromList = QtGui.QPushButton(self.layoutWidget1)
        ...
        self.button_redoList = QtGui.QPushButton(self.layoutWidget1)
        ...
        self.button_loadReview = QtGui.QPushButton(MaskEditingGui)
        self.button_loadReview.setObjectName(_fromUtf8("button_loadReview"))
        self.horizontalLayout_2.addWidget(self.button_loadReview)
    ...
    def retranslateUi(self, MaskEditingGui):
        ...
        self.button_loadReview.setText(_translate("MaskEditingGui", "Load Review", None))
