...
def locate_annotated_patches(stack, grid_spec=None, username='yuncong', force=False, annotation_rootdir=None, cerebellum_removed=True):
    """
    ...
    label_polygons = load_label_polygons_if_exists(stack, username, force=force, downsample=1,
                                                annotation_rootdir=annotation_rootdir, side_assigned=True)
