...
try:
    ...
    gx_fp = DataManager.get_volume_gradient_filepath_scratch(stack=stack, structure=structure, downscale=downscale, classifier_setting=classifier_id, suffix='gx')
    gy_fp = DataManager.get_volume_gradient_filepath_scratch(stack=stack, structure=structure, downscale=downscale, classifier_setting=classifier_id, suffix='gy')
    gz_fp = DataManager.get_volume_gradient_filepath_scratch(stack=stack, structure=structure, downscale=downscale, classifier_setting=classifier_id, suffix='gz')
