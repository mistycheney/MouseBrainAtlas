...
# for stack in ['MD591']:
    ...
    execute_command("aws s3 cp --recursive /home/yuncong/CSHL_data_processed/%(stack)s/%(stack)s_masks/ s3://mousebrainatlas-data/CSHL_data_processed/%(stack)s/%(stack)s_masks/" % {'stack': stack, 'anchor_fn': anchor_fn})
