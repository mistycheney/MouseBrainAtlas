...
DataManager.load_alignment_parameters(stack_moving=stack_moving, stack_fixed=stack_fixed,
...
for name_s in all_known_structures_sided:
    try:
        vol_m = DataManager.load_score_volume(stack=stack_moving, structure=name_s, downscale=32)
