...
class Ui_BrainLabelingGui(object):
    def setupUi(self, BrainLabelingGui):
        ...
        self.gridLayout.addWidget(self.button_load, 4, 9, 1, 1)
        ...
        self.button_saveMarkers = QtGui.QPushButton(self.layoutWidget)
        self.button_saveMarkers.setObjectName(_fromUtf8("button_saveMarkers"))
        self.gridLayout.addWidget(self.button_saveMarkers, 4, 8, 1, 1)
        self.button_loadMarkers = QtGui.QPushButton(self.layoutWidget)
        self.button_loadMarkers.setObjectName(_fromUtf8("button_loadMarkers"))
        self.gridLayout.addWidget(self.button_loadMarkers, 4, 10, 1, 1)
