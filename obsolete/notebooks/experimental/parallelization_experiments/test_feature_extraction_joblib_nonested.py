...
####################################################################
# This never uses more than one process
####################################################################
...
class FeatureExtractor(object):
    ...
    def compute_features(self):
        ...
        filtered = Parallel(n_jobs=16)(delayed(self.convolve_per_proc)(l) 
    ...
    def compute_texton(self):
        ...
        for iteration in range(n_iter):
            ...
            r = Parallel(n_jobs=16)(delayed(self.compute_dist_per_proc)(x,c) 
